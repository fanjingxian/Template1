...
void OLED_Init(void)
{
    ...
    gpio_output_options_set(PORT_LCD_SCL, GPIO_OTYPE_OD, GPIO_OSPEED_50MHZ,
                            GPIO_LCD_SCL);
    /* 配置SDA引脚 */
    gpio_mode_set(PORT_LCD_SDA, GPIO_MODE_AF, GPIO_PUPD_PULLUP, GPIO_LCD_SDA);
    gpio_output_options_set(PORT_LCD_SDA, GPIO_OTYPE_OD, GPIO_OSPEED_50MHZ,
                            GPIO_LCD_SDA);
    ...
    /* 配置I2C地址 */
    i2c_mode_addr_config(I2CX, I2C_I2CMODE_ENABLE, I2C_ADDFORMAT_7BITS,
                         I2CX_SLAVE_ADDRESS7);
    /* 使能I2C */
    i2c_enable(I2CX);
    /* 使能应答功能 */
    ...
    rcu_periph_clock_enable(RCU_LCD_SDA);
    /* 配置SCL */
    gpio_mode_set(PORT_LCD_SCL, GPIO_MODE_OUTPUT, GPIO_PUPD_PULLUP,
                  GPIO_LCD_SCL);
    gpio_output_options_set(PORT_LCD_SCL, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ,
                            GPIO_LCD_SCL);
    gpio_bit_write(PORT_LCD_SCL, GPIO_LCD_SCL, SET);

    /* 配置SDA */
    gpio_mode_set(PORT_LCD_SDA, GPIO_MODE_OUTPUT, GPIO_PUPD_PULLUP,
                  GPIO_LCD_SDA);
    gpio_output_options_set(PORT_LCD_SDA, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ,
                            GPIO_LCD_SDA);
